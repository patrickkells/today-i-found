...
Never fabricate engagement. Do not display placeholder, seeded, simulated, or otherwise invented vote totals. When the public feedback service is unavailable, show only votes actually stored in the current browser, starting from zero.
